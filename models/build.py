...
def build_model(config):
    ...
    if model_type == 'swin':
        ...
        model = GroupViT(
            ...
            orthogonal_loss_weight=config.MODEL.GVIT.ORTHOGONAL_LOSS_WEIGHT,
            attn_before_assign=config.MODEL.GVIT.ATTN_BEFORE_ASSIGN,
            assign_pos_embed=config.MODEL.GVIT.ASSIGN_POS_EMBED,
            pre_norm=config.MODEL.GVIT.PRE_NORM,
            assign_types=config.MODEL.GVIT.ASSIGN_TYPES,
            norm_eps=config.MODEL.GVIT.NORM_EPS,
            assign_eps=config.MODEL.GVIT.ASSIGN_EPS,
            proj_type=config.MODEL.GVIT.PROJ_TYPE)
