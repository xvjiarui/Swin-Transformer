...
_C.MODEL.VIT.PATCH_EMBED_TYPE = 'simple'
...
_C.MODEL.MVIT.KV_STRIDE = [8, 4, 2, 1]
_C.MODEL.MVIT.KV_KERNEL = [3, 3, 3, 1]
...
_C.MODEL.CMVIT.WITH_CLUSTER_ATTN_SKIP = True
_C.MODEL.CMVIT.ZERO_INIT_CLUSTER_TOKEN = False
_C.MODEL.CMVIT.ASSIGN_GUMBEL_TAU = 1.
_C.MODEL.CMVIT.WITH_CLUSTER_L2_NORM = False
_C.MODEL.CMVIT.I2C_SHARE_ATTN = False
_C.MODEL.CMVIT.WITH_CLUSTER_ATTN_AVG = False

# Cluster ViT
_C.MODEL.CVIT = CN()
_C.MODEL.CVIT.IN_CHANS = 3
_C.MODEL.CVIT.PATCH_SIZE = 4
_C.MODEL.CVIT.EMBED_DIM = 96
_C.MODEL.CVIT.EMBED_FACTORS = [1, 2, 4, 8]
_C.MODEL.CVIT.DEPTHS = [1, 1, 10, 1]
_C.MODEL.CVIT.NUM_CLUSTERS = [64, 32, 16, 8]
_C.MODEL.CVIT.DOWNSAMPLE_TYPES = ['conv', 'conv', 'conv']
_C.MODEL.CVIT.DIM_PER_HEAD = 96
_C.MODEL.CVIT.MLP_RATIO = 4.
_C.MODEL.CVIT.QKV_BIAS = True
_C.MODEL.CVIT.QK_SCALE = None
_C.MODEL.CVIT.ATTN_MASK_STYLE = ['c2c']
_C.MODEL.CVIT.PATCH_NORM = True
_C.MODEL.CVIT.ASSIGN_TYPE = ['gumbel', 'hard', 'inv']
_C.MODEL.CVIT.NUM_ASSIGN = [-1, -1, -1]
_C.MODEL.CVIT.INTER_MODE = 'attn'
_C.MODEL.CVIT.INTER_TYPE = []
_C.MODEL.CVIT.ASSIGN_SKIP = True
_C.MODEL.CVIT.WITH_GAP = False
_C.MODEL.CVIT.POS_EMBED_TYPE = 'simple'
_C.MODEL.CVIT.CLUSTER_TOKEN_WD = False
_C.MODEL.CVIT.PATCH_EMBED_TYPE = 'simple'
_C.MODEL.CVIT.WITH_CLUSTER_PROJ = False
_C.MODEL.CVIT.ZERO_INIT_CLUSTER_TOKEN = False
...
_C.MODEL.CVIT.CLUSTER_AS_KEY = True
_C.MODEL.CVIT.FREEZE_PATCH_EMBED = False
_C.MODEL.CVIT.ASSIGN_HEADS = 0

# Group ViT
_C.MODEL.GVIT = CN()
_C.MODEL.GVIT.IN_CHANS = 3
_C.MODEL.GVIT.PATCH_SIZE = 4
_C.MODEL.GVIT.EMBED_DIM = 96
_C.MODEL.GVIT.EMBED_FACTORS = [1, 2, 4, 8]
_C.MODEL.GVIT.DEPTHS = [1, 1, 10, 1]
_C.MODEL.GVIT.NUM_CLUSTERS = [64, 32, 16, 8]
_C.MODEL.GVIT.DOWNSAMPLE_TYPES = ['conv', 'conv', 'conv']
_C.MODEL.GVIT.DIM_PER_HEAD = 96
_C.MODEL.GVIT.NUM_HEADS = [0, 0, 0, 0]
_C.MODEL.GVIT.MLP_RATIO = 4.
_C.MODEL.GVIT.QKV_BIAS = True
_C.MODEL.GVIT.QK_SCALE = None
_C.MODEL.GVIT.ATTN_MASK_STYLE = ['c2c']
_C.MODEL.GVIT.PATCH_NORM = True
_C.MODEL.GVIT.ASSIGN_TYPE = ['gumbel', 'hard', 'inv']
_C.MODEL.GVIT.NUM_ASSIGN = [-1, -1, -1]
_C.MODEL.GVIT.INTER_MODE = 'attn'
_C.MODEL.GVIT.INTER_TYPE = []
_C.MODEL.GVIT.ASSIGN_SKIP = True
_C.MODEL.GVIT.WITH_GAP = False
_C.MODEL.GVIT.POS_EMBED_TYPE = 'simple'
_C.MODEL.GVIT.CLUSTER_TOKEN_WD = False
_C.MODEL.GVIT.PATCH_EMBED_TYPE = 'simple'
_C.MODEL.GVIT.WITH_CLUSTER_PROJ = False
_C.MODEL.GVIT.ZERO_INIT_CLUSTER_TOKEN = False
_C.MODEL.GVIT.ASSIGN_GUMBEL_TAU = 1.
_C.MODEL.GVIT.WITH_CLUSTER_ATTN_AVG = False
_C.MODEL.GVIT.PRED_SRC = ['image']
_C.MODEL.GVIT.FREEZE_PATCH_EMBED = False
